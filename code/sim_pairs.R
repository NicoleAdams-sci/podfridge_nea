##### Test Creating Pairs #####
# USAGE: module load Rtidyverse; Rscript code/sim_pairs.R <POP> <RELATIONSHIP> <No. pairs>
# Example usage: module load Rtidyverse; Rscript code/sim_pairs.R AfAm full_siblings 3
...
CHUNK_NUM <- ifelse(length(args) >= 4, args[4], "")
