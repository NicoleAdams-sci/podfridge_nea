# ------------------------------------------------------------------------------
# Module 7: Single Combo Pair Generator
# ------------------------------------------------------------------------------
...
generate_single_combo_pairs <- function(population, 
                                         relationship, 
                                         n_pairs,
                                         loci_list = NULL,
...
generate_multiple_combo_pairs <- function(combinations,
                                           loci_list = NULL,
                                           allele_frequency_data,
                                           kinship_coefficients,
                                           output_dir = "output",
  ...
  results <- combinations %>%
    rowwise() %>%
    mutate(
      result = list(generate_single_combo_pairs(
        population = population,
...
create_standard_combinations <- function(populations, relationships, n_pairs_per_combo) {
